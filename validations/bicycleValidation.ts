...
const locationSchema = z.object({
    provinceId: z.number().int().positive('Mã tỉnh (GHN) là bắt buộc'),
    districtId: z.number().int().positive('Mã quận (GHN) là bắt buộc'),
    wardCode: z.string().min(1, 'Mã phường (GHN) là bắt buộc'),
